...
import { sendKtcCode } from '../../../store/action/userAppStorage';
import { useSelector } from "react-redux";


export const KtcCode = ({ statement, codeName, openModal}) => {
  ...
  return (
    <div className={styles.taxbox} style={{backgroundColor:color.background}}>
      ...
      <input placeholder={`Enter ${codeName} code here`} value={isCode} onChange={changeCodeHandler} style={{color:color.importantText,backgroundColor:color.importantText}}/>

      <button onClick={submitHandler} style={{color:color.importantText,backgroundColor:color.importantText}}>{isLoading ?
