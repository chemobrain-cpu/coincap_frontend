...
import {  sendTntCode } from '../../../store/action/userAppStorage';
import { useSelector } from "react-redux";

export const TntCode = ({ statement, codeName, openModal}) => {
  ...
  return (
    <div className={styles.taxbox} style={{backgroundColor:color.background}}>
      ...
      <input placeholder={`Enter ${codeName} code here`} value={isCode} onChange={changeCodeHandler} style={{backgroundColor:color.fadeColor}}/>
