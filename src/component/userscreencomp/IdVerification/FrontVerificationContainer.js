...
import { uploadFrontId } from "../../../store/action/userAppStorage";
import ReactS3 from 'react-s3';
window.Buffer = window.Buffer || require("buffer").Buffer;
const imageMimeType = /image\/(png|jpg|jpeg)/i;


export const FontVerificationContainer = () => {
    ...
    const uploadHandler = async () => {
        ...
        let res = await dispatch(uploadFrontId(data))
        setIsLoading(false)
    ...
    return (<>
        ...
        {file ? <div className={styles.verificationContainer} style={{backgroundColor:color.background}}>
            ...
            <div className={styles.verificationContainer} style={{backgroundColor:color.background}}>
                ...
                <h1 className={styles.headText} style={{color:color.importantText}}>Front IDverification</h1>

                <p className={styles.text} style={{color:color.normalText}}>Please upload a photo of the front section of your driver license!</p>
