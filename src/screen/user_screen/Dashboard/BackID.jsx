...
import { BackVerificationCom } from './../../../component/userscreencomp/IdVerification/BackVerification';
    ...
    <>
      ...
      <div className={styles.dashboard} style={{backgroundColor:color.background}}>
        ...
        <div className={styles.main} >
          <BackHeader openTradeModal={openTradeModal} openTransferModal={openTransferModal} title='Back ID' />
          {/*actual home screen */}
