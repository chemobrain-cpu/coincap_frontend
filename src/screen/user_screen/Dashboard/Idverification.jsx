...
import { IdVerificationCom } from './../../../component/userscreencomp/IdVerification/idVerification';
    ...
    {isOpenTradeModal && <TradeModal closeModal={closeModal}/>}
      ...
      <div className={styles.dashboard} style={{backgroundColor:color.background}}>
        ...
        <div className={styles.main} >
          <BackHeader openTradeModal={openTradeModal} openTransferModal={openTransferModal}  title='Verification' />
          {/*actual home screen */}
